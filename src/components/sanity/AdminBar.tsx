        ...
        <div className="flex px-2 py-2 mx-4 rounded-lg bg-slate-50">
          <div className="flex col-span-4 ">
            <a className="se-item" href={`/super-login`}>
              <Image
                className="bg-superego-dark p-1.5 rounded-lg "
                src="/favicon.ico"
                alt=""
                width="50"
                height="50"
              />
              {/* <img
                className="bg-superego-dark size-13 p-1.5 rounded-lg "
                src="/favicon.svg"
                alt=""
              /> */}
            </a>
          ...
          {makeSmaller ? (
            ...
            <ul className="col-span-8 col-start-5 text-small w-full flex space-x-0.5 text-superego-dark h-full justify-end items-center my-auto">
              {menuItems.map((item, index) => (
                <li key={index}>
                  <a
                    href={item.path}
                    className="flex items-center gap-2 px-4 py-2 transition-all rounded-full hover:bg-superego-green "
                  >
                    <div
