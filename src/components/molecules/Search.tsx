...
export default function Search() {
  ...
  return (
    <>
      ...
      >
        <Icon
          className="my-auto ml-auto mr-4 transition-all md:mx-auto size-8 fill-superego-dark group-hover:rotate-12 filter bg-blend-exclusion group-hover:fill-superego-green"
          type="Search"
        />
      </button>
