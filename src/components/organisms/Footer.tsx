...
export default function Footer() {
  ...
  return (
    <>
      <footer
        className={`${gridCols} ${gridGap} ${paddingX} ${paddingY} grid pb-20 text-superego-light-base bg-superego-dark *:mx-auto md:*:mx-0`}
      >
...
function ColumnOne({ data }) {
  ...
  return (
    <div className="col-span-full sm:col-span-full md:col-span-3 lg:col-span-3 xl:col-span-6">
      <div className="">
        <Link className="text-superego-light-base" href="/">
